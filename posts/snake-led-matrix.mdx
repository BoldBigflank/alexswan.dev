...
Once I had the code where I wanted, I set up [PM2](https://pm2.io/) to run the script at startup. I have a Dynamic DNS set up and my main router does port forwarding so outside machines can hit the web server.
